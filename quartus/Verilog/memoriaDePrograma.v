...
begin
	...
	ram[55] = 32'b0;*/
ram[0] = 32'b11110000001000000000000000000001;
ram[1] = 32'b10000000001000000000000000001100;
ram[2] = 32'b11110000001000000000000000000001;
ram[3] = 32'b10000000001000000000000000010000;
ram[4] = 32'b10010000001000000000000000001100;
ram[5] = 32'b11111110000000010000000000010000;
ram[6] = 32'b10010000001000000000000000010000;
ram[7] = 32'b11111110001000010000000000010000;
ram[8] = 32'b11111110000100010000000000010011;
ram[9] = 32'b11111100010000000000000000010110;
ram[10] = 32'b11111110000100010000000000010000;
ram[11] = 32'b11111110001000100000000000010000;
ram[12] = 32'b11111100000000100000000000011111;
ram[13] = 32'b11000100000000000000000000001000;
ram[14] = 32'b11111100001100000000000000010000;
ram[15] = 32'b11110100001000000000000000000000;
