## [Índices](#sumário)
*  [1. Definição do Conjunto de Instruções](#definição-do-conjunto-de-instruções-1)
...
* ### [3. Formato de Instruções](#formato-de-instruções)
	* #### [3.1 Tipo 1(Registrador)](#tipo-1registrador)
		* [3.1.1 Soma](#soma)
		* [3.1.2 Subtração](#subtração)
		* [3.1.3 Multiplicação R3](#multiplicação-r3)
		* [3.1.4 Divisão R3](#divisão-r3)
		* [3.1.5 Lógica ou](#lógica-ou)
		* [3.1.6 Lógica não ou](#lógica-não-ou)
		* [3.1.7 Lógica e](#lógica-e)
		* [3.1.8 Lógica não e](#lógica-não-e)
		* [3.1.9 Lógica ou exclusivo](#lógica-ou-exclusivo)
		* [3.1.10 Lógica não ou exclusivo](#lógica-não-ou-exclusivo)
		* [3.1.11 Menor que R3](#menor-que-r3)
		* [3.1.12 Maior que R3](#maior-que-r3)
		* [3.1.13 Mover](#mover)
		* [3.1.14 Deslocamento para direita](#deslocamento-para-direita)
		* [3.1.15 Deslocamento para esquerda](#deslocamento-para-esquerda)
		* [3.1.16 Obter tempo](#obter-tempo)
		* [3.1.17 Igual R3](#igual-r3)
		* [3.1.18 Diferente R3](#diferente-r3)
		* [3.1.19 Multiplicação R2](#multiplicação-r2)
		* [3.1.20 Divisão R2](#divisão-r2)
		* [3.1.21 Mover de HI](#mover-de-hi)
		* [3.1.22 Mover de LO](#mover-de-lo)
		* [3.1.23 Obter tempo do programa](#obter-tempo-do-programa)
		* [3.1.25 Igual R2](#igual-r2)
		* [3.1.26 Diferente R2](#diferente-r2)
		* [3.1.27 Menor que R2](#menor-que-r2)
		* [3.1.28 Maior que R2](#maior-que-r2)
		* [3.1.30 Salto Registrador](#salto-registrador)
		* [3.1.31 Salto Registrador Condicional](#salto-registrador-condicional)
		* [3.1.32 Negar](#negar)
	* #### [3.2 Tipo 2(Imediato 1)](#tipo-2imediato-1)
		* [3.2.1 Soma I com sinal](#soma-i-com-sinal)
		* [3.2.2 Subtração I com sinal](#subtração-i-com-sinal)
		* [3.2.3 Multiplicação R2I com sinal](#multiplicação-r2i-com-sinal)
		* [3.2.4 Divisão R2I com sinal](#divisão-r2i-com-sinal)
		* [3.2.5 Lógica ou I](#lógica-ou-i)
		* [3.2.6 Lógica não ou I](#lógica-não-ou-i)
		* [3.2.7 Lógica e I](#lógica-e-i)
		* [3.2.8 Lógica não e I](#lógica-não-e-i)
		* [3.2.9 Lógica ou exclusivo I](#lógica-ou-exclusivo-i)
		* [3.2.10 Lógica não ou exclusivo I](#lógica-não-ou-exclusivo-i)
		* [3.2.11 Menor que I](#menor-que-i)
		* [3.2.12 Maior que I](#maior-que-i)
		* [3.2.14 Deslocamento para direita I](#deslocamento-para-direita-i)
		* [3.2.15 Deslocamento para esquerda I](#deslocamento-para-esquerda-i)
		* [3.2.17 Igual R2I](#igual-r2i)
		* [3.2.18 Diferente R2I](#diferente-r2i)
		* [3.2.19 Soma I com sinal e overflow](#soma-i-com-sinal-e-overflow)
		* [3.2.20 Subtração I com sinal e overflow](#subtração-i-com-sinal-e-overflow)
	* #### [3.3 Tipo 3(Imediato 2)](#tipo-3imediato-2)
		* [3.3.1 Multiplicação RI  com sinal](#multiplicação-ri-com-sinal)
		* [3.3.2 Divisão RI  com sinal](#divisão-ri-com-sinal)
		* [3.3.3 Igual RI](#igual-ri)
		* [3.3.4 Diferente RI](#diferente-ri)
		* [3.3.5 Menor que RI](#menor-que-ri)
		* [3.3.6 Maior que RI](#maior-que-ri)
		* [3.3.7 Carregar Imediato](#carregar-imediato)
	* #### [3.4 Tipo 4(Memória 1)](#tipo-4memória-1)
		* [3.4.1 Carregar](#carregar)
		* [3.4.2 Carregar Meia Palavra](#carregar-meia-palavra)
		* [3.4.3 Carregar Byte](#carregar-byte)
		* [3.4.4 Empilhar](#empilhar)
		* [3.4.5 Descarregar](#descarregar)
		* [3.4.6 Descarregar Meia Palavra](#descarregar-meia-palavra)
		* [3.4.7 Descarregar Byte](#descarregar-byte)
		* [3.4.8 Desempilhar](#desempilhar)
	* #### [3.5 Tipo 6(Memória 2)](#tipo-5memória-2)
		* [3.5.1 Carregar RI](#carregar-ri)
		* [3.5.2 Carregar Meia Palavra RI](#carregar-meia-palavra-ri)
		* [3.5.3 Carregar Byte RI](#carregar-byte-ri)
		* [3.5.5 Descarregar RI](#descarregar-ri)
		* [3.5.6 Descarregar Meia Palavra RI](#descarregar-meia-palavra-ri)
		* [3.5.7 Descarregar Byte RI](#descarregar-byte-ri)
	* #### [3.6 Tipo 6(Salto)](#tipo-6salto)
		* [3.6.1 Salto](#salto)
		* [3.6.2 Salto condicional](#salto-condicional)
		* [3.6.3 Saltar e conectar](#saltar-e-conectar)
		* [3.6.4 Saltar e desconectar](#saltar-e-desconectar)
	* #### [3.7 Tipo 7(Entrada/Saída)](#tipo-7entradasaída)
